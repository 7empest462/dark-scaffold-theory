...
\subsubsection{Early Massive Galaxies (JWST)}
Standard $\Lambda$CDM predicts only $\sim 0.5$ massive galaxies ($>10^{10} M_\odot$) in a 100 Mpc box at $z=15$. In contrast, our simulations produce \textbf{683} candidates in the same volume. The pre-existing potential wells allow baryons to collapse immediately after recombination, bypassing the hierarchical delay.
